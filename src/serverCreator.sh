...
docker run -d -p $puerto_disponible:3001 -e SERVER_ID=$id -e MY_PORT=$puerto_disponible -e KNOWN_PORTS=$puertos_conocidos --name "server$puerto_disponible" lonyonserver
